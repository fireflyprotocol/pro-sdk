...
class Signature:
    ...
    def login(self, payload: LoginRequest) -> bytes:
        ...
        data = {
            ...
            "signedAtUtcMillis": int(payload.signed_at_utc_millis),
            "audience": payload.audience,
        }

        message = self.create_personal_sign_message(data, is_pretty_json=False)
    ...
    def create_personal_sign_message(self, data:json, is_pretty_json: bool = True) -> bytes:
        """
        ...
        if is_pretty_json:
            ...
            uint8_array = list(json.dumps(data, separators=(',', ':')).encode('utf-8'))
