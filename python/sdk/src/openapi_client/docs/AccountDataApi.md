...
> AccountValueHistory get_account_value_history_by_account(account_address)
...
async with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.AccountDataApi(api_client)
    account_address = 'account_address_example' # str | Account address to fetch account value history for.

    try:
        # /accounts/{accountAddress}/valueHistory
        api_response = await api_instance.get_account_value_history_by_account(account_address)
        print("The response of AccountDataApi->get_account_value_history_by_account:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AccountDataApi->get_account_value_history_by_account: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **account_address** | **str**| Account address to fetch account value history for. | 
