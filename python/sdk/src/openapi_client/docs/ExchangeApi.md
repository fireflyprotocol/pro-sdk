...
> List[List[str]] get_candlestick_data(symbol, interval, type, start_time_at_utc_millis=start_time_at_utc_millis, end_time_at_utc_millis=end_time_at_utc_millis, limit=limit, page=page)
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    start_time_at_utc_millis = 1499040000000 # int | Timestamp in milliseconds in ms to get klines from. (optional)
    end_time_at_utc_millis = 1499644799999 # int | Timestamp in milliseconds in ms to get klines until. (optional)
    ...
    try:
        # Kline/candlestick data.
        api_response = await api_instance.get_candlestick_data(symbol, interval, type, start_time_at_utc_millis=start_time_at_utc_millis, end_time_at_utc_millis=end_time_at_utc_millis, limit=limit, page=page)
 ...
 **start_time_at_utc_millis** | **int**| Timestamp in milliseconds in ms to get klines from. | [optional] 
 **end_time_at_utc_millis** | **int**| Timestamp in milliseconds in ms to get klines until. | [optional] 
...
> List[FundingRateEntry] get_funding_rate_history(symbol, limit=limit, start_time_at_utc_millis=start_time_at_utc_millis, end_time_at_utc_millis=end_time_at_utc_millis, page=page)
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    start_time_at_utc_millis = 56 # int | The timestamp specifies the earliest point in time for which data should be returned. The value is not included. (optional)
    end_time_at_utc_millis = 56 # int | The timestamp specifies the latest point in time for which data should be returned. The value is included. (optional)
    page = 56 # int | The page number to retrieve in a paginated response. (optional)

    try:
        # Get funding rate history
        api_response = await api_instance.get_funding_rate_history(symbol, limit=limit, start_time_at_utc_millis=start_time_at_utc_millis, end_time_at_utc_millis=end_time_at_utc_millis, page=page)
 ...
 **start_time_at_utc_millis** | **int**| The timestamp specifies the earliest point in time for which data should be returned. The value is not included. | [optional] 
 **end_time_at_utc_millis** | **int**| The timestamp specifies the latest point in time for which data should be returned. The value is included. | [optional] 
 **page** | **int**| The page number to retrieve in a paginated response. | [optional] 
...
# **get_recent_trades**
> List[Trade1] get_recent_trades(symbol, trade_type=trade_type, limit=limit, start_time_at_utc_millis=start_time_at_utc_millis, end_time_at_utc_millis=end_time_at_utc_millis, page=page)
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Recent trades list
        api_response = await api_instance.get_recent_trades(symbol, trade_type=trade_type, limit=limit, start_time_at_utc_millis=start_time_at_utc_millis, end_time_at_utc_millis=end_time_at_utc_millis, page=page)
