...
class KoraCampaignMetadata(BaseModel):
    """
    KoraCampaignMetadata
    """ # noqa: E501
    status: StrictStr
    campaign_name: StrictStr = Field(description="Name of the campaign", alias="campaignName")
    parent_campaign_name: Optional[StrictStr] = Field(default=None, description="Name of the parent campaign", alias="parentCampaignName")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parentCampaignName": obj.get("parentCampaignName"),
