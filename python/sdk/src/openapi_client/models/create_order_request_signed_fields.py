...
class CreateOrderRequestSignedFields(BaseModel):
    """
    CreateOrderRequestSignedFields
    """ # noqa: E501
    symbol: StrictStr = Field(description="The symbol of the perpetual for which to create the order")
    ...
    __properties: ClassVar[List[str]] = ["symbol", "accountAddress", "priceE9", "quantityE9", "side", "leverageE9", "isIsolated", "salt", "idsId", "expiresAtUtcMillis", "signedAtUtcMillis"]
