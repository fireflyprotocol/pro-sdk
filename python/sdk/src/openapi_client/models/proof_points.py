...
class ProofPoints(BaseModel):
    ...
    """ # noqa: E501
    a: List[StrictStr] = Field(description="Point A of the proof.")
    b: List[List[StrictStr]] = Field(description="Point B of the proof.")
    c: List[StrictStr] = Field(description="Point C of the proof.")
