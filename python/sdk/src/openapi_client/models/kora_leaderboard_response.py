...
class KoraLeaderboardResponse(BaseModel):
    """
    KoraLeaderboardResponse
    """ # noqa: E501
    data: List[KoraLeaderboardEntry]
    total: StrictInt = Field(description="Total number of records")
    limit: StrictInt = Field(description="Page size for pagination")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [KoraLeaderboardEntry.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total"),
            "limit": obj.get("limit"),
            "page": obj.get("page")
        })
