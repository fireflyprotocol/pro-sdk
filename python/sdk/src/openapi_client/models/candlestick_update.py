...
class CandlestickUpdate(BaseModel):
    ...
    """ # noqa: E501
    symbol: StrictStr = Field(description="The symbol of the market for this candlestick.")
    ...
    __properties: ClassVar[List[str]] = ["symbol", "startTime", "endTime", "interval", "openPriceE9", "closePriceE9", "highPriceE9", "lowPriceE9", "volumeE9", "quoteVolumeE9", "numTrades"]
