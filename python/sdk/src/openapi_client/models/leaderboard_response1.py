...
class LeaderboardResponse1(BaseModel):
    """
    LeaderboardResponse1
    """ # noqa: E501
    entries: List[LeaderboardEntry1]
    total: Optional[StrictInt] = Field(default=None, description="Total number of users (for pagination).")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [LeaderboardEntry1.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
            "total": obj.get("total")
        })
        return _obj
