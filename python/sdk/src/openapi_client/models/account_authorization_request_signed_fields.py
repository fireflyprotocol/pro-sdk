...
class AccountAuthorizationRequestSignedFields(BaseModel):
    """
    AccountAuthorizationRequestSignedFields
    """ # noqa: E501
    account_address: StrictStr = Field(description="The account address of the parent account that is authorizing/deauthorizing this account", alias="accountAddress")
