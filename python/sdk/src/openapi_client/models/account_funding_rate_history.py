...
class AccountFundingRateHistory(BaseModel):
    """
    AccountFundingRateHistory
    """ # noqa: E501
    data: List[AccountFundingRateHistoryData]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [AccountFundingRateHistoryData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
