...
class MarketSubscriptionStreams(BaseModel):
    """
    Represents the type of market data stream and its parameters.
    """ # noqa: E501
    symbol: StrictStr = Field(description="The symbol of the market stream to subscribe to (Leave empty for TickerAll stream)")
    streams: List[MarketDataStreamName]
    __properties: ClassVar[List[str]] = ["symbol", "streams"]
