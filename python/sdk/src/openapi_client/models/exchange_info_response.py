    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.assets:
            ...
            _dict['assets'] = _items
        # override the default output from pydantic by calling `to_dict()` of contracts_config
        if self.contracts_config:
            _dict['contractsConfig'] = self.contracts_config.to_dict()
