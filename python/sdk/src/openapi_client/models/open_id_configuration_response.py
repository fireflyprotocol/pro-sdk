...
class OpenIDConfigurationResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["issuer", "authorization_endpoint", "jwks_uri", "token_endpoint", "response_types_supported", "id_token_signing_alg_values_supported", "subject_types_supported", "scopes_supported"]
