...
class AuthApi:
    ...
    @validate_call
    async def auth_v2_token_post_with_http_info(
        self,
        payload_signature: StrictStr,
        login_request: LoginRequest,
        refresh_token_valid_for_seconds: Annotated[Optional[StrictInt], Field(description="The number of seconds the refresh token is valid for. If not provided, the default is 30 days.")] = None,
    ...
    @validate_call
    async def auth_v2_token_post_without_preload_content(
        self,
        payload_signature: StrictStr,
        login_request: LoginRequest,
        refresh_token_valid_for_seconds: Annotated[Optional[StrictInt], Field(description="The number of seconds the refresh token is valid for. If not provided, the default is 30 days.")] = None,
    ...
    async def get_zk_login_user_details(
        ...
        _param = self._get_zk_login_user_details_serialize(
            zklogin_jwt=zklogin_jwt,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ZKLoginUserDetailsResponse",
            '400': "Error",
            '500': "Error",
        }
        response_data = await self.api_client.call_api(
    ...
    @validate_call
    async def get_zk_login_user_details_with_http_info(
        self,
        zklogin_jwt: Annotated[StrictStr, Field(description="The JWT of the user signed in with zkLogin.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_zk_login_user_details_without_preload_content(
        self,
        zklogin_jwt: Annotated[StrictStr, Field(description="The JWT of the user signed in with zkLogin.")],
        _request_timeout: Union[
            None,
    ...
    def _get_zk_login_user_details_serialize(
        self,
        zklogin_jwt,
        _request_auth,
        _content_type,
        ...
        # process the query parameters
        # process the header parameters
        if zklogin_jwt is not None:
            _header_params['zklogin-jwt'] = zklogin_jwt
        # process the form parameters
        # process the body parameter
    ...
    async def post_zk_login_zkp(
        self,
        zklogin_jwt: Annotated[StrictStr, Field(description="The JWT of the user signed in with zkLogin.")],
        zk_login_zkp_request: ZKLoginZKPRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param zklogin_jwt: The JWT of the user signed in with zkLogin. (required)
        :type zklogin_jwt: str
        :param zk_login_zkp_request: (required)
        :type zk_login_zkp_request: ZKLoginZKPRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_zk_login_zkp_serialize(
            zklogin_jwt=zklogin_jwt,
            zk_login_zkp_request=zk_login_zkp_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def post_zk_login_zkp_with_http_info(
        self,
        zklogin_jwt: Annotated[StrictStr, Field(description="The JWT of the user signed in with zkLogin.")],
        zk_login_zkp_request: ZKLoginZKPRequest,
        _request_timeout: Union[
    ...
    @validate_call
    async def post_zk_login_zkp_without_preload_content(
        self,
        zklogin_jwt: Annotated[StrictStr, Field(description="The JWT of the user signed in with zkLogin.")],
        zk_login_zkp_request: ZKLoginZKPRequest,
        _request_timeout: Union[
    ...
    def _post_zk_login_zkp_serialize(
        self,
        zklogin_jwt,
        zk_login_zkp_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if zk_login_zkp_request is not None:
            _body_params = zk_login_zkp_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/auth/zklogin/zkp',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
