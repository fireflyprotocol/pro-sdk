...
class RewardsApi:
    ...
    async def get_contract_config(
        ...
        _param = self._get_contract_config_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def get_contract_config_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_contract_config_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_contract_config_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/rewards/contract/config',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def get_user_bonuses(
        self,
        epoch_number: Annotated[StrictInt, Field(description="Specify the epoch number")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_user_bonuses_serialize(
            epoch_number=epoch_number,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[KoraUserBonusResponse]",
            '400': "Error",
        }
        response_data = await self.api_client.call_api(
            *_param,
    ...
    @validate_call
    async def get_user_bonuses_with_http_info(
        self,
        epoch_number: Annotated[StrictInt, Field(description="Specify the epoch number")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[KoraUserBonusResponse]]:
        """Get all user bonuses by epoch
    ...
    @validate_call
    async def get_user_bonuses_without_preload_content(
        self,
        epoch_number: Annotated[StrictInt, Field(description="Specify the epoch number")],
        _request_timeout: Union[
            None,
    ...
    def _get_user_bonuses_serialize(
        self,
        epoch_number,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/rewards/bonuses',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def mark_as_claimed(
        self,
        mark_as_claimed_request: MarkAsClaimedRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param mark_as_claimed_request: (required)
        :type mark_as_claimed_request: MarkAsClaimedRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._mark_as_claimed_serialize(
            mark_as_claimed_request=mark_as_claimed_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def mark_as_claimed_with_http_info(
        self,
        mark_as_claimed_request: MarkAsClaimedRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MarkAsClaimedResponse]:
        """/v1/rewards/claims/mark-claimed
    ...
    @validate_call
    async def mark_as_claimed_without_preload_content(
        self,
        mark_as_claimed_request: MarkAsClaimedRequest,
        _request_timeout: Union[
            None,
    ...
    def _mark_as_claimed_serialize(
        self,
        mark_as_claimed_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if mark_as_claimed_request is not None:
            _body_params = mark_as_claimed_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/rewards/claims/mark-claimed',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def update_affiliate_ember_refferal_share(
        self,
        update_affiliate_ember_refferal_share_request: UpdateAffiliateEmberRefferalShareRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param update_affiliate_ember_refferal_share_request: (required)
        :type update_affiliate_ember_refferal_share_request: UpdateAffiliateEmberRefferalShareRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_affiliate_ember_refferal_share_serialize(
            update_affiliate_ember_refferal_share_request=update_affiliate_ember_refferal_share_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def update_affiliate_ember_refferal_share_with_http_info(
        self,
        update_affiliate_ember_refferal_share_request: UpdateAffiliateEmberRefferalShareRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def update_affiliate_ember_refferal_share_without_preload_content(
        self,
        update_affiliate_ember_refferal_share_request: UpdateAffiliateEmberRefferalShareRequest,
        _request_timeout: Union[
            None,
    ...
    def _update_affiliate_ember_refferal_share_serialize(
        self,
        update_affiliate_ember_refferal_share_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_affiliate_ember_refferal_share_request is not None:
            _body_params = update_affiliate_ember_refferal_share_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/rewards/affiliate/emberRefferalShare',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
