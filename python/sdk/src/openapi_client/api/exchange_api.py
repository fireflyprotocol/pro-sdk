...
class ExchangeApi:
    ...
    @validate_call
    async def get_all_market_ticker(
        self,
        ...
        _param = self._get_all_market_ticker_serialize(
    ...
    @validate_call
    async def get_all_market_ticker_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_all_market_ticker_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_all_market_ticker_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/exchange/tickers',
    ...
    @validate_call
    async def get_country_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_country_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_country_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/exchange/country',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def get_exchange_stats_all_time_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[StatsAllTimeResponse]:
        """/v1/exchange/stats/allTime
    ...
    def _get_exchange_stats_all_time_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/exchange/stats/allTime',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def get_funding_rate_history(
        ...
        :param symbol: The market symbol to get funding rate history for (required)
        :type symbol: str
    ...
    async def get_market_ticker(
        self,
        symbol: Annotated[StrictStr, Field(description="Market symbol.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def get_orderbook_depth(
        self,
        symbol: Annotated[StrictStr, Field(description="Market symbol to get the orderbook depth for.")],
