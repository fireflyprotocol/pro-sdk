...
class AccountDataApi:
    ...
    @validate_call
    async def get_account_value_history_by_account(
        self,
        account_address: Annotated[StrictStr, Field(description="Account address to fetch account value history for.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param account_address: Account address to fetch account value history for. (required)
        :type account_address: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_account_value_history_by_account_serialize(
            account_address=account_address,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def get_account_value_history_by_account_with_http_info(
        self,
        account_address: Annotated[StrictStr, Field(description="Account address to fetch account value history for.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_account_value_history_by_account_without_preload_content(
        self,
        account_address: Annotated[StrictStr, Field(description="Account address to fetch account value history for.")],
        _request_timeout: Union[
            None,
    ...
    def _get_account_value_history_by_account_serialize(
        self,
        account_address,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/accounts/{accountAddress}/valueHistory',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
