...
**parentCampaignName** | **string** | Name of the parent campaign | [optional] [default to undefined]
...
```typescript
import { KoraCampaignMetadata } from '@bluefin/api-client';

const instance: KoraCampaignMetadata = {
    status,
    campaignName,
    parentCampaignName,
    startDate,
