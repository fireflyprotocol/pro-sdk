...
# Build all formats (ESM, CJS, and type definitions)
npm run build
...
The repository includes a comprehensive example demonstrating all SDK features:
...
Please see [CONTRIBUTING.md](./CONTRIBUTING.md) for guidelines on contributing to the SDK.

**Important**: Always run `example.ts` after making changes to verify nothing is broken:
...
Or use the automated tool from the repository root:

```bash
cargo run --bin apigen -- --lang typescript
```

## Support and Documentation

- **Main Repository**: [fireflyprotocol/pro-sdk](https://github.com/fireflyprotocol/pro-sdk)
- **Documentation**: Additional guides available in the [docs](./docs) directory
- **Issues**: Report issues on [GitHub Issues](https://github.com/fireflyprotocol/pro-sdk/issues)

## License

This project is licensed under the Unlicense - see the package.json for details.
