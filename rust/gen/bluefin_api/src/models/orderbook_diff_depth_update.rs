...
impl OrderbookDiffDepthUpdate {
    pub fn new(updated_at_utc_millis: i64, symbol: String, bids_e9: Vec<Vec<String>>, asks_e9: Vec<Vec<String>>, first_update_id: i64, last_update_id: i64) -> OrderbookDiffDepthUpdate {
